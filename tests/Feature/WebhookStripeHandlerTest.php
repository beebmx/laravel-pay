...
class WebhookStripeHandlerTest extends FeatureTestCase
{
    /** @test */
    ...
    protected function mockResponse(string $id, string $status = 'succeeded', string $type = 'payment_intent.succeeded')
    {
        return [
